...
export const JOURNAL_POSTS: JournalPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Amazon.ca logistics are a gift—Prime delivery to remote Ontario towns, easy returns when fabric fails the light test. Always filter for fulfilled-by-Amazon when possible, read recent reviews from Canadian buyers, and confirm return windows before Eid deadlines. Affiliate links through HalalStyle do not change your price; they fund our Excellence Filter so every recommendation is vetted, not sponsored noise.",
      ...
      "That is the HalalStyle standard: faith-aligned coverage, editorial-grade materials, real life in Canada. Explore our featured abaya picks below—each passed the same filter we apply to our own families’ closets.",
    ],
  },
  {
