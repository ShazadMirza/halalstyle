...
export interface VaultItem {
  ...
  description: string;
  whyHalal: string;
  /** Stable remote image (Next/Image). Keyword kept for search / alt context. */
  imageKeyword: string;
  imageUrl: string;
  affiliateUrl: string;
...
export const VAULT_ITEMS: VaultItem[] = [
  ...
  },
  {
    ...
    imageKeyword: "hijab",
    imageUrl:
      "https://images.unsplash.com/photo-1583292650773-4a70031048b7?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1503919545229-fb2b24470c99?auto=format&fit=crop&w=800&q=80",
